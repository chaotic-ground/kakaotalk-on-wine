...
mutter는 포커스가 없는 클라이언트의 요청도 받아들였습니다. 창 둘을
띄우고 번갈아 앞으로 나오라고 하는 시험 프로그램으로 확인했습니다. 다른
앱이 앞에 있어도 5초마다 창이 올라옵니다. 보장은 아니고 컴포지터가
정하는 것이라, 거절할 때를 위해 확장에 대비책이 있습니다. 거절은 창에
"주의를 요함" 표시를 남기고, 확장의 `_onDemandsAttention`이 그 신호를
받습니다.
