...
| 창이 스스로 앞으로 나오기 | 됨, **패치한 Wine**(0007) |
...
**창이 스스로 앞으로 나오기**는 알림을 눌렀을 때 대화창이 앞으로
나오는 것입니다. Wayland에서 클라이언트는 자기 창을 올릴 수 없고,
컴포지터에게 부탁하는 방법이 xdg-activation입니다. winewayland에 그것이
없었습니다.

알림이 그냥 **올 때는** 아무것도 올라오지 않습니다. mutter가 그 요청은
거절하고 창에 표시만 남깁니다. 윈도우도 같습니다. 배경 프로세스의
`SetForegroundWindow`를 OS가 거절하고 작업 표시줄 단추를 깜빡입니다.
